...
/// <summary>
/// Thin, generic wrapper over Mudbase.Sdk.Api.DataApi for the events/bookings/activity
...
///   into our own POCO.
/// - List reads: the generated SDK's list-item model (`DataListResponseDataInner`) populates its
///   `AdditionalProperties` dictionary for every field beyond `_id`/`createdAt`/`updatedAt`. This
