...
/// `deleteDocument`. Every project-scoped `DataAPI` call needs `projectId` + `collectionId`, so this
/// fixes both once per gateway instance instead of threading them through every call site.
struct CollectionsGateway: Sendable {
